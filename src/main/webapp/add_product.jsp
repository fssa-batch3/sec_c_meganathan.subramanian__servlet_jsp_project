        ...
        <form action="<%= request.getContextPath()+"/AddBookServlet" %>" method="post">
            ...
            <div class="inpt-form">
                <div class="first-inpt-box">
                    ...
                    <div class="form-group">
                        <label for="authorImgUrl">Author Image URL:</label>
                        <input type="text" id="authorImgUrl" name="authorImgUrl" required>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="booklanguage" name="booklanguage" required>
                    </div>
                    <div class="form-group">
                        <label for="publisherImprint">Publisher Imprint:</label>
                        <input type="text" id="publisherImprint" name="publisherImprint" required>
                    </div>
                </div>
                ...
                <div class="second-inpt-box">
                    <div class="form-group">
                        ...
                        <input type="date" id="publisherDate" name="publisherDate" required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label for="bookwidth">Book Width:</label>
                        <input type="text" id="bookwidth" name="bookwidth" required>
                    </div>
                    <div class="form-group">
                        <label for="noOfPages">Number of Pages:</label>
                        <input type="text" id="noOfPages" name="noOfPages" required>
                    </div>
                    <div class="form-group">
                        <label for="bookHeight">Book Height:</label>
                        <input type="text" id="bookHeight" name="bookHeight" required>
                    </div>
                    <div class="form-group">
                        <label for="bookDepth">Book Depth:</label>
                        <input type="text" id="bookDepth" name="bookDepth" required>
                    </div>
                    <div class="form-group">
                        <label for="bookWeight">Book Weight:</label>
                        <input type="text" id="bookWeight" name="bookWeight" required>
                    </div>
                    <!-- Categories -->
                    <div class="form-group">
                        <label for="BookCategory">Select the Category:</label> <select name="book_category">
                    ...
                    <div class="form-group">
                        ...
                        <select id="bookBinding" name="bookBinding" required>
                            <option value="" disabled selected>Select One</option>
                    ...
                    <!-- Returnable -->
                    <div class="form-group">
                        <label for="returnable">Is Book Returnable?</label>
                        <select id="returnable" name="returnable" required>
                            <option value="" disabled selected>Select One</option>
